;;; Inspired by dracula-theme.el --- Dracula Theme
;;; sed -i -e "s/#ff79c6/#863f68/g" -e "s/#f8f8f2/#060605/g" -e "s/#ffb86c/#936a3e/g" -e "s/#8be9fd/#3f6972/g" -e "s/#a2b2e4/#343949/g" -e "s/#50fa7b/#37ad54/g" -e "s/#f1fa8c/#6c703e/g" print-theme.el
...
(let ((colors '(;; Upstream theme color
                ...
                (dracula-green   "#37ad54" "#5fff87" "green")       ; official green
                (dracula-orange  "#936a3e" "#ffaf5f" "brightred")   ; official orange
                (dracula-pink    "#863f68" "#ff87d7" "magenta")     ; official pink
                (dracula-purple  "#bd93f9" "#af87ff" "brightmagenta") ; official purple
                (dracula-red     "#ff5555" "#ff8787" "red")         ; official red
                (dracula-yellow  "#6c703e" "#ffff87" "yellow")      ; official yellow
                ;; Other colors
      ...
      (faces '(;; default
               ...
               ;; tuareg
               (tuareg-doc-face :foreground ,dracula-fg :background ,dracula-bg)
               (tuareg-font-double-colon-face :foreground ,dracula-red :background ,dracula-bg)
               (tuareg-font-lock-attribute-face :foreground ,dracula-fg :background ,dracula-bg)
               (tuareg-font-lock-constructor-face :foreground ,dracula-fg :background ,dracula-bg)
               (tuareg-font-lock-error-face :foreground ,dracula-fg :background ,dracula-bg)
               (tuareg-font-lock-extension-node-face :foreground ,dracula-fg :background ,dracula-bg)
               (tuareg-font-lock-governing-face :foreground ,dracula-orange :background ,dracula-bg)
               (tuareg-font-lock-infix-extension-node-face :foreground ,dracula-fg :background ,dracula-bg)
               (tuareg-font-lock-interactive-directive-face :foreground ,dracula-fg :background ,dracula-bg)
               (tuareg-font-lock-interactive-error-face :foreground ,dracula-fg :background ,dracula-bg)
               (tuareg-font-lock-interactive-output-face :foreground ,dracula-fg :background ,dracula-bg)
               (tuareg-font-lock-label-face :foreground ,dracula-fg :background ,dracula-bg)
               (tuareg-font-lock-line-number-face :foreground ,dracula-fg :background ,dracula-bg)
               (tuareg-font-lock-module-face :foreground ,dracula-fg :background ,dracula-bg)
               (tuareg-font-lock-multistage-face :foreground ,dracula-fg :background ,dracula-bg)
               (tuareg-font-lock-operator-face :foreground ,dracula-fg :background ,dracula-bg)
               ;; undo-tree
